    ...
    <ScrollView>
        ...
        <View style={Styles.modal}>
            <View style={Styles.formContainer}>
                <TextInput placeholder='Città' style={Styles.input} value={formState.city} onChangeText={text => {setFormState({...formState,city:text})}}/>
                <TextInput placeholder='Indirizzo' style={Styles.input} value={formState.adress} onChangeText={text => {setFormState({...formState,adress:text})}}/>
                <TextInput placeholder='Numero carta di credito (16 numeri)' style={Styles.input} value={formState.creditCart} onChangeText={text => {setFormState({...formState,creditCart:text})}}/>
                <TextInput placeholder='CVV (3 numeri)' style={Styles.input} value={formState.CVV} onChangeText={text => {setFormState({...formState,CVV:text})}}/>
                {readyToBuy ? <CustomButton title='Compra' onPress={buyed} /> : <CustomButton title='compila i campi'/> }
